...
(* OASIS_START *)
(* DO NOT EDIT (digest: 26806f812a824c1ef8a50c0de984f44b) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_strings", []))];
       ...
       [
          ("cohttp",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "cohttp"});
          ("cohttp_lwt_unix",
            OCamlbuildDocPlugin.doc_build
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Stringext"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_strings.ml"});
               Executable
                 ({
                     cs_name = "test_accept";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\151AK\202\178/g\180\189\236\245*\211\0286\250";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
